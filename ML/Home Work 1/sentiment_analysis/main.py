...
# Your code here
print(" accuracy   :", p1.classifier_accuracy(p1.pegasos,train_bow_features,test_bow_features, train_labels,test_labels
, T= 25, L=.01))
...
# best_theta = p1.pegasos(train_bow_features,train_labels,25,.01)[0] # Your code here
